...
const SignUp = ({ setSignedIn }) => {
	...
	return (
		<>
			<title>Booket List | Sign Up</title>
			<div className="  mt-10 ">
				<div>
					<h2 className="text-xl sm:text-3xl font-semibold mb-10 text-center">
					...
					<div className="flex justify-center items-center flex-col ">
						<form onSubmit={(e) => handleSubmit(e)}>
							...
							<button
								className="w-60 block m-auto text-white rounded-lg h-9 pl-3 mt-2 mb-7 bg-[#1747B5]"
								type="submit"
							>
