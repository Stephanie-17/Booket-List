  ...
  return (
    <div className='flex justify-center items-center mb-30'>
      <div className='flex justify-center items-center flex-col mt-8' >
         <img  className='w-[80%]' src={heroImg} alt="" />
         <div className='text-center text-white'>
            ...
            <button className='bg-[#1466B8] text-white mt-6 px-4 py-2 rounded-lg cursor-pointer' onClick={()=>setCurrentPage('sign-up')} >Sign in</button>
         </div>
